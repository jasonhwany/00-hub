...
export const metadata: Metadata = { title: "서비스 소개", description: "MoneyStom7의 운영 목적과 원칙을 소개합니다.", alternates: { canonical: "https://www.moneystom7.com/about" } };
export default function Page(){return <ContentPage eyebrow="About us" title="복잡한 숫자를 더 나은 결정으로" intro="MoneyStom7은 세금과 금융 정보를 누구나 이해하고 비교할 수 있는 실용적인 의사결정 도구로 바꾸는 독립 서비스입니다." sections={[
